...
class DependenciesWhiteListExtension {
    ...
    void init() {
        ...
        dependenciesWhiteList.add("androidx.constraintlayout:constraintlayout:2.0.4")
        ...
        dependenciesWhiteList.add("junit:junit:4.13.1")
        ...
        dependenciesWhiteList.add("com.bosh.demo:library:0.0.12")
        ...
        dependenciesWhiteList.add("com.android.tools.build:aapt2:3.4.2-5326820")// gradle的依赖
        ...
        dependenciesWhiteList.add("com.android.tools.lint:lint-gradle:27.2.2")
    }
